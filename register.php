...
{
	$sql = mysqli_query($con,"INSERT INTO user (name, email, password, contact, address, useruid) VALUES ('$name', '$email', '$passwrd', '$contact' , '$address', '$uid') ")or die(mysqli_error($con));
